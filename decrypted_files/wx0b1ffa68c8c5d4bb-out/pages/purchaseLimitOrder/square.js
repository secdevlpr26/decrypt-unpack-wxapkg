...
var a, e = getApp(), s = require("../../components/picker_datetime.js"), i = require("../shop/AddrManage.js"), r = require("../../components/city-picker.js"), d = require("../../config.js");
...
Page((a = {
    ...
    onLoad: function(t) {
        ...
        this.loadSquareInfo(), this.datetimePicker = new s.pickerDatetime({
            ...
            animation: "slide",
            duration: 200
        }), this.navigateBackFunc(!0), this.addrManage = new i({
            page: this,
            onSelected: this.onAddrManageClick
        }), this.cityPicker = new r(), this.getBalanceNumber();
    },
    data: {
        integralFlag: !1,
        paymentPlugShow: !1,
    ...
    var a = this;
    e.sendRequest({
        url: "/index.php?c=front/WxApp/SecKill&a=deliveryFee&district_id=" + t + "&products_str=" + this.data.squareInfo.product_id + "|" + this.data.queryparams.ms_product_num + "&ActivityID=" + a.data.ActivityID + "&ProductID=" + a.data.SkillInfo.SeckillProID + "&SiteID=" + a.data.SkillInfo.address.SiteID + "&SkuID=" + this.data.SkillInfo.SkuID,
        method: "GET",
        hideLoading: !0,
        success: function(t) {
            if (200 == !t.code) e.showModal({
                title: "提示",
                content: "操作失败：" + t.msg
            }); else {
                var s = (a.data.productSubtotal + t.data.freight_fee).toFixed(2);
                a.setData({
    ...
    if (this.data.defaultAddr) {
        var s = t.detail.value, i = (this.cityPicker.getDistrictCodeByName(this.data.defaultAddr.ProvinceName, this.data.defaultAddr.CityName, this.data.defaultAddr.DistrictName), 
        {});
        a.setData({
            fromId: t.detail.formId
        }), i.ms_id = this.data.queryparams.ms_id, i.ms_product_id = this.data.queryparams.ms_product_id, 
        i.ms_product_num = this.data.queryparams.ms_product_num, i.sku_id = this.data.queryparams.sku_id, 
        i.sku_status = this.data.queryparams.sku_status, i.address_id = this.data.defaultAddr.ID, 
        i.remark = s.Memo, a.navigateBackFunc(!1), e.sendRequest({
