var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
    ...
    loadPageModules: function(t) {
        ...
        t.page && (o = t.page);
        var n = a.route.match(/(CustomPage_\d+)_tabbar/i);
        n && n.length > 1 && (o = n[1]), t.sharepage && (o = t.sharepage), this.sendRequest({
                ...
                if (t.success) try {
                    t.modules.forEach(function(t) {
                        t.CouponList && t.CouponList.forEach(function(t) {
                            if (t.beginTime = t.BeginTime.split(" ")[0].split("-").join("."), 0 == t.Type ? t.Amount < 100 && t.Amount >= 10 ? 0 == t.Amount.split("")[1] ? t.amount = t.Amount.split("")[0] : t.amount = t.Amount.split("").join(".") : 100 == t.Amount ? t.amount = t.Amount.split("")[0] + t.Amount.split("")[1] : t.Amount < 10 && t.Amount > 0 ? t.amount = "0." + t.Amount : t.amount = t.Amount : t.amount = t.Amount, 
                            "0" === t.EndTimeType) {
                    ...
                    e.CACHEKEY = t.cachekey, e.getPurchaseLimit();
                } catch (t) {
    ...
    getPurchaseLimit: function() {
        var t = this, e = getCurrentPages()[getCurrentPages().length - 1];
    ...
    setFloatLayerInfo: function(t) {
        ...
        if (o.setData({
            scrollTopCurrent: 0,
            scrollBottomNum: 0
        }), 1 == a.EnableNormalBtnShow) {
            o.onPageScroll = function(t) {
            ...
            var l = this;
            o.goToHomeIndex = function() {
                l.navTo("HomeIndex");
            };
        }
    },
    adjustFloatLayer: function(t) {
        var a = this.getCurPage(), o = (t = t || a.data.floatLayerInfo || {}).ShowPages || "", n = this.getFloatLayerCurPageName(), i = new RegExp(n, "i").test(o);
        ...
        t.EnableNormalBtnShow = r ? 1 : 0;
        var s = 1 == this.getCurPage().options.fromShare, l = s && /(productdetail)|(servicedetail)|(custompage)/i.test(n) && /(meirong)|(peixun)|(meifa)|(jianshen)|(jianzhan)/i.test(e.globalData.baseInfo.Industry);
        return l = l || s && /custompage/i.test(n), t.EnableGoToHomeIndex = l ? 1 : 0, t;
    },
