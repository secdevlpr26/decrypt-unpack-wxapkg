...
Page({
    ...
    getAddressList: function() {
        var a = this, s = "";
        s = "02" == a.data.djlx ? "7" : "8", wx.request({
    ...
    addAddress: function() {
        ...
        console.log(t.data.zrzxbm), wx.navigateTo({
            url: "/pages/jkdmx/jkdmx?id=0&lcbm=" + t.data.lcbm + "&nf=" + t.data.nf + "&zrzxbm=" + t.data.zrzxbm + "&zrzxmc=" + t.data.zrzxmc + "&ztbm=" + t.data.ztbm + "&djlx=" + t.data.djlx + "&djmc=" + t.data.djmc
        });
    },
    edit: function(t) {
        var a = this;
        ...
        console.log(e + s), wx.navigateTo({
            url: "/pages/jkdmx/jkdmx?id=" + e + "&userId=" + s + "&djlx=" + a.data.djlx + "&lcbm=" + a.data.lcbm + "&zrzxbm=" + a.data.zrzxbm + "&zrzxmc=" + a.data.zrzxmc
        });
    },
    delete: function(a) {
