            ...
            success: function(a) {
                if (console.log(a.data.status), 1 == a.data.status) wx.showToast({
                    ...
                    console.log(s), t.getAddressList(), wx.navigateTo({
                        url: "/pages/yssymx/yssymx?id=OBS" + s + "&lcbm=" + t.data.lcbm + "&ztbm=" + t.data.ztbm + "&djlx=" + t.data.djlx + "&djmc=" + t.data.djmc + "&nf=" + t.data.nf + "&zrzxbm=" + t.data.zrzxbm + "&zrzxmc=" + t.data.zrzxmc + "&sqje=0"
                    });
                }
            }
        });
