...
Page({
            ...
            success: function(a) {
                if (console.log(a.data.status), 1 == a.data.status) wx.showToast({
                    ...
                    console.log(s), t.getAddressList(), wx.navigateTo({
                        url: "/pages/yssymxcl/yssymxcl?id=OBS" + s + "&lcbm=" + t.data.lcbm + "&ztbm=" + t.data.ztbm + "&djlx=" + t.data.djlx + "&djmc=" + t.data.djmc + "&nf=" + t.data.nf + "&zrzxbm=" + t.data.zrzxbm + "&zrzxmc=" + t.data.zrzxmc + "&sqje=0"
                    });
                }
            }
        });
    ...
    tijiao: function(t) {
        ...
        wx.request({
            ...
            success: function(t) {
                if (console.log(t.data.status), 1 == t.data.status) s.setData({
                    ls_ce: 1
                }), wx.showToast({
                    title: "报销总金额≠各子明细总和金额",
                    icon: "none",
                    duration: 2e3
                }); else {
                    if (s.setData({
                        ls_ce: 0
                    }), 1 == s.data.ls_tj) return void wx.showToast({
                        title: "亲，请等等",
                        icon: "loading",
                        duration: 1500
                    });
