    ...
    setFloatLayerInfo: function(t, e) {
        ...
        if (n.setData({
            ...
            n.onPageScroll = function(t) {
                if (t) {
                    var e = "number" == typeof t.scrollTop ? t.scrollTop : t.detail.scrollTop, a = this.data && this.data.scrollTopCurrent || 0;
                    this.data.scrollTopCurrent, l = !(e - a > 0), this.data.scrollBottomNum && this.data.scrollBottomNum < e && (l = !1), 
                    e < 50 && (l = !1), this.setData({
                        showTopFlag: l,
                        scrollTopCurrent: e
                    });
                }
            }, n.scrollToTop = function(t) {
                this.data.scrollFlag ? this.setData({
                    scrollTopNum: 0
                }) : wx.pageScrollTo({
                    scrollTop: 0,
                    duration: 500
        ...
        if (o || 0 == o) {
            ...
            clearInterval(s["fullReduction" + o]), s["fullReduction" + o] = setInterval(function() {
                ...
                p.forEach(function(t, e) {
                    h.push(i.data["activityTimeArr" + e]);
                }), i.setData({
                    key: p,
                    timeInterval: h
                }), n && n(0);
