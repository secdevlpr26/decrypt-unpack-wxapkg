...
Page({
    ...
    initData: function(t) {
        ...
        var s = wx.getStorageSync("invite") || 0, o = wx.getStorageSync("hasMobile") || 0, i = a.globalData.getMobileNode ? a.globalData.getMobileNode.entryBusinessCardHome : 0;
        0 === a.globalData.hasMobile && 1 === e.data.authorization && 0 === o && 0 !== s && 0 !== i && 1 !== e.data.phonestatus && e.setData({
            allowspopup: !0,
            authorizationStu: 1
        }), e.setData({
            authorization: 1
            ...
            success: function(e) {
                if (t.isloading = !1, e.success) {
                    if (null === e.info.card_info || "" === e.info.card_info) t.setData({
                        ...
                        var o = e.info.card_info;
                        o.Recording && (t.myaudio.src = t.data.baseUrl + o.Recording, t.setData({
                            "music.duration": o.RecordingTime,
                            Recording: o.Recording
                        }));
                        for (var i = e.info.recordImage, n = 0; n < i.length; n++) i[n].Image && i[n].Image.indexOf("https://wx.qlogo.cn/") < 0 && (i[n].Image = a.globalData.siteBaseUrl + i[n].Image);
                        ...
                        "" === o.QQ && "" === o.WeChat && "" === o.Email && "0" === o.checkAddress ? t.setData({
    ...
    abolish: function() {
        ...
        a.setData({
            ...
            url: "/pages/company/businessCard/chatDialogue?UserID=" + a.data.BusinssUserID + "&SiteID=" + a.data.cardsiteID + "&BusinessCardID=" + (a.data.optionsobj.BusinessCardID ? a.data.optionsobj.BusinessCardID : a.data.optionsobj.cid) + "&OtherName=" + a.data.BusinssCardName
        });
    },
    ...
    onShareAppMessage: function(t) {
        var e = this, s = e.data.currentTab, o = e.data.optionsobj;
        if (o.currentTab = s, 0 == s) {
            if (1 != e.data.cardchoice) {
                var i = {
                    tbUserID: a.globalData.WebUserID,
                    tbType: "5",
        ...
        if (1 == s) {
            o.userid = a.globalData.WebUserID;
            var u = "", l = "", g = "";
            if (t.target) {
                var D = t.target.dataset.articleid;
                u = t.target.dataset.title, l = "" + e.data.baseUrl + t.target.dataset.img, g = "/pages/shop/newsdetail?id=" + D + "&businessid=" + o.BusinessCardID + "&userid=" + a.globalData.WebUserID, 
                e.addTranspond(D);
            } else g = a.getPageUrl(e, o);
            return a.shareAppMessage({
                url: g,
                title: u,
                imageUrl: l
    ...
    businessCardsList: function() {
        ...
        setTimeout(function() {
            wx.navigateTo({
                url: "/pages/company/businessCard/cardcase?ID=" + a.data.userID + "&BusinessCardID=" + a.data.cardcontent.ID + "&isBinding=" + a.data.isBindingMember
            });
        }, 50);
    },
    goeditCard: function() {
        ...
        setTimeout(function() {
            wx.navigateTo({
                url: "/pages/company/businessCard/editCard?ID=" + a.data.cardcontent.ID + "&mark=1"
            });
        }, 50);
    },
    ...
    goAccessRecord: function() {
        ...
        setTimeout(function() {
            wx.navigateTo({
                url: "/pages/company/businessCard/accessRecord?ID=" + a.data.cardcontent.ID
            });
        }, 50);
    },
    ...
    toLeaveWrod: function(t) {
        ...
        var s = wx.getStorageSync("hasMobile") || 0, o = a.globalData.getMobileNode ? a.globalData.getMobileNode.entryOnlineMessage : 0;
        0 === a.globalData.hasMobile && 0 === s && 0 !== o ? this.setData({
            allowspopup: !0,
            cellphone: t.currentTarget.dataset.tbphone
        }) : wx.navigateTo({
            url: "/pages/company/businessCard/chatDialogue?UserID=" + e.data.BusinssUserID + "&SiteID=" + e.data.cardsiteID + "&BusinessCardID=" + (e.data.optionsobj.BusinessCardID ? e.data.optionsobj.BusinessCardID : e.data.optionsobj.cid) + "&OtherName=" + e.data.BusinssCardName
        });
    },
    ...
    getDynmicList: function(t) {
        ...
        var s = e.data.recordcount, o = e.data.dynamicList.length;
        if (s > o && e.data.falgAjax) {
            e.setData({
                falgAjax: !1
            });
            var i = Math.ceil(o / e.data.pagesize) + 1;
            a.sendRequest({
    ...
    errArticleImg: function(a) {
        var t = this, e = a.target.dataset.errImg, s = a.target.dataset.errIndex, o = t.data.dynamicList;
        o[s].ImgBig = e, t.setData({
            dynamicList: o
        });
    },
    ...
    clickLove: function(t) {
        var e = this, s = t.currentTarget.dataset.articleid, o = a.globalData.WebUserID ? a.globalData.WebUserID : 0;
        a.sendRequest({
    ...
    toComment: function(t) {
        var e = this, s = t.currentTarget.dataset.articleid, o = a.globalData.WebUserID ? a.globalData.WebUserID : 0;
        a.sendRequest({
            url: "/index.php?c=Front/WxApp/Dynamic/Dynamic&a=getUserCommentCount&ArticleID=" + s + "&UserID=" + o,
            method: "GET",
            success: function(t) {
                e.setData({
                    showPopFlag: !1
    ...
    addComment: function(t) {
        var e = this, s = e.data.articleID, o = e.data.currentIndex, i = a.globalData.WebUserID ? a.globalData.WebUserID : 0, n = e.data.dynamicList;
        a.sendRequest({
                        ...
                        if (d.success) {
                            if (1 == r.info.EnableCommentReviewMobile) {
                                if (0 != i) {
                                    ...
                                    n[o].CommentList.push({
                                        nickname: c,
                                        comment: t
                                    });
                                } else n[o].CommentList.push({
                                    nickname: "游客",
                                    comment: t
                                });
                                e.setData({
                            ...
                            if (1 != e.data.cardchoice && 0 != i) {
                                var u = {
                                    tbUserID: i,
                                    tbType: "14",
                                    tbTypeID: s,
                                    tbTypeName: n[o].Title,
                                    tbTypeImg: n[o].ImgBig,
                                    tbBusinessCardID: e.data.optionsobj.BusinessCardID ? e.data.optionsobj.BusinessCardID : e.data.optionsobj.cid
                                };
    ...
    getMaterialList: function(t, e) {
        ...
        var o = "";
        t && (o = t), s.data.materualFlagThree && (s.setData({
            materualFlagThree: !1
        }), a.sendRequest({
            url: "/index.php?c=Front/Material/Material&a=getMaterialList&page=" + s.data.productPage + "&tagID=" + o + "&userID=",
            method: "GET",
            success: function(a) {
                if (s.setData({
                    materualFlagThree: !0
                    ...
                    var o = [];
                    t || e ? o = a.list : (o = s.data.materialList, a.list.forEach(function(a) {
                        o.push(a);
                    })), s.setData({
                        materialList: o,
    ...
    copyText: function(t) {
        var e = this, s = t.currentTarget.dataset.descriptor, o = e.data.materialList[s].Descriptor;
        wx.setClipboardData({
            data: o,
            success: function(t) {
                a.showToast({
        ...
        wx.getSetting({
            success: function(e) {
                if (e.authSetting["scope.writePhotosAlbum"]) {
                    var s = a.currentTarget.dataset.saveindex, o = [];
                    if (0 == (o = t.data.materialList[s].MaterialContent).length) return;
                    o.forEach(function(a, e) {
                        o[e].indexOf("https") < 0 && (o[e] = t.data.baseUrl + a);
                    });
                    var i = 0;
                    t.saveLoad(o[i], function(a) {
                        if (a) {
                            if (wx.showToast({
                                title: "第" + (i + 1) + "张成功",
                                icon: "success",
    ...
    getPhoneNumber: function(t) {
        var s = this, o = t.detail.errMsg.indexOf("getPhoneNumber:ok") > -1;
        if (s.setData({
            allowspopup: !1
        }), o) {
            var i = a.globalData.appId, n = a.globalData.session_key, r = new e(i, n).decryptData(t.detail.encryptedData, t.detail.iv);
            a.loadphoneInfo(r.phoneNumber), "1" === s.data.cellphone ? s.getphone() : "2" === s.data.cellphone && (s.setData({
                showGetMobileBtn: !1
            }), wx.navigateTo({
                url: "/pages/company/businessCard/chatDialogue?UserID=" + s.data.BusinssUserID + "&SiteID=" + s.data.cardsiteID + "&BusinessCardID=" + (s.data.optionsobj.BusinessCardID ? s.data.optionsobj.BusinessCardID : s.data.optionsobj.cid) + "&OtherName=" + s.data.BusinssCardName
            }));
        } else if ("1" === s.data.cellphone) s.getphone(); else if ("2" === s.data.cellphone) return void wx.navigateTo({
            url: "/pages/company/businessCard/chatDialogue?UserID=" + s.data.BusinssUserID + "&SiteID=" + s.data.cardsiteID + "&BusinessCardID=" + (s.data.optionsobj.BusinessCardID ? s.data.optionsobj.BusinessCardID : s.data.optionsobj.cid) + "&OtherName=" + s.data.BusinssCardName
        });
    },
    toWrokBench: function() {
        ...
        setTimeout(function() {
            t.data.isFromWorkBench ? wx.navigateBack({
                ...
                url: "/pages/company/businessCard/workbench?BusinessCardID=" + e + "&SiteID=" + s
            });
        }, 50);
    }
});