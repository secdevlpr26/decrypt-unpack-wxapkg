var e = getApp(), t = require("../../common.js"), a = require("../../components/wxb.js");
...
Page({
    ...
    onLoad: function(a) {
        ...
        var i = wx.getStorageSync("hasMobile") || 0, o = e.globalData.getMobileNode ? e.globalData.getMobileNode.readArticles : 0, r = 0, d = getCurrentPages(), l = d[d.length - 1];
        s.data.queryparams.id && (r = s.data.queryparams.id), 0 === e.globalData.hasMobile && 0 === i && "1" === s.data.queryparams.fromShare && 0 !== o && (this.setData({
            phonestatus: 1
        }), 2 === o ? wx.redirectTo({
    ...
    getUserWhetherLike: function(t) {
        var a = this, s = t.id, n = e.globalData.WebUserID ? e.globalData.WebUserID : 0;
        e.sendRequest({
            url: "/index.php?c=Front/WxApp/Dynamic/Dynamic&a=getUserWhetherLike&ArticleID=" + s + "&UserID=" + n,
            method: "GET",
            success: function(e) {
                e.success ? a.setData({
                    hasLike: 1 == e.IsLike
            ...
            e.sendRequest({
                ...
                success: function(n) {
                    if (n.success) {
                        ...
                        i.LikeCount = Number(i.LikeCount) + 1, t.setData({
                            newsInfo: i,
                            hasLike: !0
                        });
                    } else e.showToast({
    ...
    toComment: function(t) {
        ...
        var s = wx.getStorageSync("hasMobile") || 0, n = e.globalData.getMobileNode ? e.globalData.getMobileNode.commentArticles : 0;
        0 === e.globalData.hasMobile && 0 === s && 0 !== n ? this.setData({
            phonelicense: !0,
            phonestatus: 2
        }) : a.evaluate();
    },
    ...
    toCardDetail: function() {
        var t = this, a = t.data.queryparams.businessid, s = e.globalData.siteId, n = t.data.queryparams.userid;
        wx.navigateTo({
            url: "/pages/company/businessCard/cardDetails?BusinessCardID=" + a + "&SiteID=" + s + "&userid=" + n
        });
    },
    ...
    addComment: function(t) {
        var a = this, s = a.data.newsInfo, n = s.ArticleID, i = e.globalData.WebUserID ? e.globalData.WebUserID : 0;
        e.sendRequest({
            ...
            success: function(o) {
                o.success && e.sendRequest({
                    ...
                    success: function(r) {
                        if (r.success) {
                            if (0 != i) if (wx.getStorageSync("businessCardInfo").admin) if (wx.getStorageSync("otherMemberCardId")) {
                                var d = {
                                    tbUserID: i,
                                    tbType: "14",
                                    tbTypeID: n,
                            ...
                            if (1 == o.info.EnableCommentReviewMobile) {
                                if (0 != i) {
                                    var c = e.globalData.userInfo.nickName, b = e.globalData.userInfo.avatarUrl;
                                    s.CommentList.push({
                                        nickname: c,
                                        comment: t,
                                        headurl: b
    ...
    getPhoneNumber: function(t) {
        ...
        if (n = 1 === s.data.phonestatus ? e.globalData.getMobileNode.readArticles : e.globalData.getMobileNode.commentArticles, 
        t.detail.errMsg.indexOf("getPhoneNumber:ok") > -1) {
            var i = e.globalData.appId, o = e.globalData.session_key, r = new a(i, o).decryptData(t.detail.encryptedData, t.detail.iv);
