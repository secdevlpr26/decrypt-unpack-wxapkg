...
Page({
    ...
    getGoodsByKeywords: function(t, s, o) {
        ...
        a = n[0], i = n[1];
        var h = wx.getStorageSync("cityid");
        e.getJSON("/Goods/search/keywords/" + t + "/cityid/" + h + "/p/" + s + "/sort/" + a + "/sort_asc/" + i, function(t) {
    ...
    getGoods: function(t, s, o) {
        ...
        a = n[0], i = n[1];
        var h = wx.getStorageSync("cityid");
        e.getJSON("/Goods/goodsList/id/" + t + "/cityid/" + h + "/sort/" + n[0] + "/sort_asc/" + n[1] + "/p/" + s, function(t) {
            var s = t.data.result.goods_list, e = d.data.goods;
            for (var o in s) e.push(s[o]);
