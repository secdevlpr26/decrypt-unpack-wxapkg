        ...
        a = this, n.getShareInfos(a, t), wx.getStorage({
            ...
            success: function(n) {
                wx.setNavigationBarTitle({
                    ...
                    storeInfoBusinessTime: n.data.storeInfoBusinessStartTime + "-" + n.data.storeInfoBusinessEndTime
                });
            }
        }), n.setCompanyId(a, e), wx.getStorage({
            key: "storeId",
            success: function(n) {
                a.setData({
                    storeId: n.data
                    ...
                    success: function(n) {
                        ...
                        var e = '<div class="word">' + n.data.content + "</div>";
                        console.log("article ==> " + e), o.wxParse("article", "html", e, a, 20);
                    }
                });
            },
            fail: function(a) {
