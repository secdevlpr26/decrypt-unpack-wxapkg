...
Page({
    ...
    onLoad: function(a) {
        ...
        "1" == a.hasReceived ? e.setData({
            ...
            success: function(o) {
                o.data;
                console.error("comid--", o.data), wx.getStorage({
                    key: "userId",
                    success: function(o) {
                        var a = o.data;
                        console.error("userId--", o.data), wx.getStorage({
                            key: "cardId",
                            success: function(o) {
                                console.error("cardId--", o.data), wx.getStorage({
                                    key: "storeId",
                                    success: function(c) {
                                        console.error("storeId--", o.data), wx.request({
    ...
    onHide: function() {},
    onUnload: function() {
        o.closeSock(), e.data.hasReceived;
    },
