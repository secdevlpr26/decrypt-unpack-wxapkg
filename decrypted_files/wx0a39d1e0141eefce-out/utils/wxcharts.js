...
function I(t, e, i, n) {
    var a = e.data;
    n.beginPath(), n.setFontSize(i.fontSize), n.setFillStyle("#666666"), t.forEach(function(t, o) {
        if (null !== t) {
            var r = e.format ? e.format(a[o]) : a[o];
            "below" == e.textPosition ? n.fillText(r, t.x - c(r) / 2, t.y + 2 + i.fontSize) : n.fillText(r, t.x - c(r) / 2, t.y - 2);
        }
...
function Y(t, e, i, n) {
    if (!0 !== e.yAxis.disabled) {
        var a = C(t, e, i).rangesFormat, o = i.yAxisWidth + i.yAxisTitleWidth, r = e.height - 2 * i.padding - i.xAxisHeight - i.legendHeight, s = Math.floor(r / i.yAxisSplit), l = i.padding + o, h = e.width - i.padding, c = e.height - i.padding - i.xAxisHeight - i.legendHeight;
      ...
      case "line":
        this.animationInstance = new U({
            ...
            onProcess: function(t) {
                ...
                j(r, e, i, n), Z(e.series, e, i, n), Y(o, e, i, n), q(e, i, n, t), Q(e, n);
            },
