var t = getApp(), a = "", e = "", o = 1, i = 1, n = "", s = "", r = "", c = [ "LynxProductList", "LynxAbout_Merchant", "LynxPhoto_Info_Post_Tab", "LynxPhoto_H_Info_Tab_Level2", "Photo-Info-Tab-Level2", "Video_Gallery", "Flexi-Form", "Online-Chat", "Activity", "LynxApplyFor_About_Merchant", "Activity-Group", "About-Merchant", "Activity-Kill" ];
...
Page({
    ...
    initData: function() {
        ...
        console.log(t.globalData.city), i.getJoinPhone(), wx.setNavigationBarTitle({
            ...
            posCity: "",
            productArr: []
        }), clearInterval(s), i.getHomepageBaseInfo().then(function() {
            i.getHomePageTop(), i.getCustomizeTabList().then(function() {
                ...
                i.getHomepageAdvertise(), i.getHomepageProduct(), i.getProCategory();
            });
        ...
        return new Promise(function(o, i) {
            wx.request({
                ...
                success: function(a) {
                    ...
                    for (var r = c, l = [], u = 0; u < i.length; u++) for (var g = 0; g < r.length; g++) "" != i[u].sysTabNameTag && i[u].sysTabNameTag == r[g] ? l.push(i[u]) : "" == i[u].sysTabNameTag && i[u].sysTabName == r[g] && l.push(i[u]);
                    if ("O2O_V1" == e.data.minaInfo.subVersion) {
                        for (var d = Math.ceil(l.length / 8), p = [], h = 0; h < d; h++) p[h] = [], p[h].push(l.slice(8 * h, 8 * (h + 1)));
    ...
    getReommendProducts: function() {
        ...
        wx.request({
            ...
            success: function(a) {
                var e = t.getJsonData(a.data);
                i = e.pages;
                for (var n = 0; n < e.pageList.length; n++) e.pageList[n].productModelList[0] && String(e.pageList[n].productModelList[0].stock).length > 3 && (e.pageList[n].productModelList[0].stock = String(e.pageList[n].productModelList[0].stock).substring(0, 3)), 
                String(Math.abs(e.pageList[n].quantity)).length > 3 && (e.pageList[n].quantity = String(Math.abs(e.pageList[n].quantity)).substring(0, 3)), 
                String(e.pageList[n].readTimes).length > 3 && (e.pageList[n].readTimes = String(e.pageList[n].readTimes).substring(0, 3));
                o.setData({
