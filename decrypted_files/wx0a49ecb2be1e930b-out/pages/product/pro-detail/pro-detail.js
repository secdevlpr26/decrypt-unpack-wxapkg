...
var t = getApp(), a = "", e = "", o = "", i = [], r = !0, n = !0, d = !1, c = "", s = 0, u = 0, l = 0, p = 0, h = 0, g = 0, m = [], I = [], f = "", y = "", v = "", b = "";
...
Page({
    ...
    getProDetail: function() {
        var e = this;
        return i = [], m = [], I = [], f = "", y = "", v = "", b = "", e.setData({
            moduleId: y,
            modelName: b
            ...
            wx.request({
                ...
                success: function(a) {
                    ...
                    if (1 == i.status) wx.hideToast(), wx.showModal({
                        ...
                        var v = i.remark;
                        v = (v = (v = (v = (v = (v = v.replace(/&ldquo;/g, "“")).replace(/&rdquo;/g, "”")).replace(/&mdash;/g, "—")).replace(/&middot;/g, "·")).replace(/&hellip;/g, "…")).replace(/<img(?=.*?\/>)/gi, '<img style="width: 100%; height: auto;" '), 
                        e.setData({
                            proInfoDetail: i,
                            price: s,
                            originalPrice: u,
            ...
            "3" == e.data.proInfoDetail.purpose) {
                ...
                if (h) {
                    ...
                    void wx.showModal({
                        ...
                        confirmText: "去购物车",
                        success: function(t) {
                            t.confirm && (e.data.isPerson ? wx.navigateTo({
                                url: "../../self/cart/cart"
                            }) : wx.switchTab({
                                url: "../../self/cart/cart"
                            }));
                    ...
                    if (m && (i.push(r), "1" == a)) return void (e.data.isPerson ? wx.navigateTo({
                        url: "../../self/cart/cart"
                    }) : wx.switchTab({
                        url: "../../self/cart/cart"
                    }));
    ...
    carttap: function() {
        this.data.isPerson ? wx.navigateTo({
            url: "../../self/cart/cart"
        }) : wx.switchTab({
            url: "../../self/cart/cart"
        });
    ...
    originalPriceBuy: function() {
        ...
        if (console.log(o), 0 != o) {
            ...
            void wx.showModal({
                ...
                confirmText: "去购物车",
                success: function(t) {
                    t.confirm && (a.data.isPerson ? wx.navigateTo({
                        url: "../../self/cart/cart"
                    }) : wx.switchTab({
                        url: "../../self/cart/cart"
                    }));
            ...
            void (a.data.isPerson ? wx.navigateTo({
                url: "../../self/cart/cart"
            }) : wx.switchTab({
                url: "../../self/cart/cart"
            }));
    ...
    getModuleId: function(t) {
        for (var a = this, e = t.split(";"), o = a.data.proInfoDetail.productModelList, i = e[1] + ";" + e[0], r = 0; r < o.length; r++) if (o[r].valueIds == t || o[r].valueIds == i) {
            y = o[r].id, v = o[r].originalAttr, b = o[r].modelName, a.setData({
                stock: o[r].stock,
                price: o[r].price,
    ...
    toggleProAttrFrame: function() {
        ...
        this.setData({
            ...
            showProAttr: !this.data.showProAttr,
            buyType: ""
        }), 0 == this.data.activityType && this.setData({
            attrBtnStatus: 2
        });
    },
