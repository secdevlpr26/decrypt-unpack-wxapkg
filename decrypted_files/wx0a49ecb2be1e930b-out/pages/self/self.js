...
Page({
    ...
    onLoad: function() {
        var o = this;
        t = a.globalData.projectInfo, e = a.globalData.customizeTabId, a.loginVzSystem(), 
        wx.getSetting({
            success: function(t) {
    ...
    onShow: function() {
        ...
        t.setData({
            phone: e
        }), t.animal(), a.globalData.wxUserInfo && a.globalData.wxUserInfo.avatarUrl ? this.setData({
                ...
                for (var o = a.getJsonData(t.data), n = 0; n < o.length; n++) {
                    ...
                    switch (o[n].sysTabNameTag ? o[n].sysTabNameTag : o[n].sysTabName) {
                      ...
                      case "Photo-Info-Tab-Level2":
                        e.data.showCustomizeTabId["Photo-Info-Tab-Level2"] = !0;
                        break;
    ...
    getUserInfo: function() {
        ...
        wx.request({
            ...
            success: function(e) {
                ...
                wx.setStorageSync("memberId" + a.globalData.autoId, o.id), 3 == o.type && o.activated && wx.setStorageSync("memberType" + a.globalData.autoId, o.type), 
                wx.setStorageSync("nickname" + a.globalData.autoId, o.userName), wx.setStorageSync("mobilePhone" + a.globalData.autoId, o.mobilePhone), 
                t.setData({
                    userInfo: o,
                    phone: o.mobilePhone
                }), wx.hideToast();
    ...
    headtap: function() {
        wx.navigateTo({
            url: "acountInformation/acountInformation"
        });
    },
    toOrderList: function(t) {
        a.getMemberId() ? wx.navigateTo({
            url: "myOrder/myOrder?index=" + t.currentTarget.dataset.index
        }) : wx.navigateTo({
            url: "../login/login"
        });
    },
    ...
    cardtap: function() {
        a.getMemberId() ? wx.navigateTo({
            url: "card/card?cardNo=" + this.data.userInfo.cardNo
        }) : (console.log(a.getMemberId()), wx.navigateTo({
            url: "../login/login"
        }));
    },
    toSupply: function() {
    ...
    memRigtap: function() {
        a.getMemberId() ? wx.navigateTo({
            url: "memRights/memRights"
        }) : wx.navigateTo({
            url: "../login/login"
        });
    },
    toStore: function() {
        0 == a.globalData.isPerson ? wx.switchTab({
            url: "../store/store"
        }) : wx.navigateTo({
            url: "../store/store"
        });
    ...
    toDistribute: function() {
        a.getMemberId() ? wx.navigateTo({
            url: "../distribute/distribute?type=" + this.data.userInfo.type
        }) : wx.navigateTo({
            url: "../login/login"
        });
    },
