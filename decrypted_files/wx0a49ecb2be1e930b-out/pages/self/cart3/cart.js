...
Page({
    ...
    onLoad: function(t) {
        r = t.from, "o2o-shop" == this.data.projectType ? this._productList1Init() : "shop" == this.data.projectType && this._productList2Init();
    },
    onShow: function() {
        var a = this;
    ...
    onReachBottom: function() {
        c < i && (c++, "o2o-shop" == this.data.projectType ? this.getProCategory1() : "shop" == this.data.projectType && this.getProductList());
    },
