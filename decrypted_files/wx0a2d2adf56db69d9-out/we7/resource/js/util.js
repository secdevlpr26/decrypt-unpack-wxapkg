...
util.url = function(e, t) {
    ...
    e[2] && (a += "do=" + e[2] + "&")), t) for (param in t) param && t[param] && (a += "param=" + t[param] + "&");
    return a;
        ...
        wx.login({
            success: function(n) {
                util.request({
                    ...
                    cachetime: 0,
                    success: function(n) {
                        t.sessionid = n.data.data.sessionid, wx.setStorageSync("userInfo", t), wx.getUserInfo({
                            success: function(n) {
                                console.log("wxinfo"), t.wxInfo = n.userInfo, wx.setStorageSync("userInfo", t), 
                                util.request({
                                    ...
                                    success: function(n) {
                                        ...
                                        console.log(e), "function" == typeof e && e(t);
                                    }
                                });
                            },
                            fail: function(t) {
                                ...
                                wx.openSetting({
                                    success: function(t) {
                                        t.authSetting["scope.userInfo"] && t.authSetting["scope.userLocation"] || util.getUserInfo(e);
                                    }
                                });
                            },
                            complete: function() {}
    ...
    n.sessionid && n.memberInfo.uid ? wx.checkSession({
        success: function() {
