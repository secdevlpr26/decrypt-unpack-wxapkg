...
Page({
    data: (a = {
        ...
        showProvince: !1,
        showCity: !1
    }, t(a, "show", !1), t(a, "noStore", !0), t(a, "bottomHint", !0), t(a, "homePageLayout", e.globalData.projectInfo.homePageLayout), 
    t(a, "currentSwiper", 0), t(a, "autoplay", !0), a),
    ...
    onLoad: function() {
        o = e.globalData.projectInfo, r = e.globalData.customizeTabId, wx.showToast({
            title: "加载中...",
            icon: "loading",
            duration: 1e4,
            mask: !0
        }), o = e.globalData.projectInfo, r = e.globalData.customizeTabId;
        var t = this;
    ...
    toStoreDetails: function(t) {
        wx.navigateTo({
            url: "../store-detail/store-detail?tabContentId=" + t.currentTarget.dataset.pid
        });
    },
    storeInfo: function() {
        var t = this, a = {
        ...
        t.data.cityId > 0 && (a.cityId = t.data.cityId), t.data.categoryId && (a.categoryId = t.data.categoryId);
        try {
            wx.request({
                ...
                success: function(a) {
                    ...
                    o.pageList[r].pic1 = e.modifyPicSize(o.pageList[r].pic1, "_rx160p");
                    t.setData({
    ...
    onShareAppMessage: function() {
        return {
            title: "商铺",
            path: "/pages/store/layout-o2o/store",
            success: function(t) {},
            fail: function(t) {}
        };
    }
