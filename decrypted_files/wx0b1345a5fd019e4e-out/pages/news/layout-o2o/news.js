...
Page({
    ...
    onLoad: function(i) {
        a = t.globalData.projectInfo, e = t.globalData.customizeTabId, console.log(t.globalData), 
        console.log(e);
        var s = this;
        "LynxPhoto_H_Info_Tab_Level2" == (o = i.sysTabName) ? (s.getAdList(), s.setData({
            news_type: 3
        })) : s.setData({
            news_type: 4
