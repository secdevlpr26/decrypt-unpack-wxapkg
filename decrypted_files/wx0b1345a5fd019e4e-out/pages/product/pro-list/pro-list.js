var t = getApp(), a = 1, e = 1, i = !1, o = void 0, s = void 0, r = void 0, c = void 0, n = void 0, d = void 0, u = t.globalData.projectInfo;
...
Page({
    ...
    packaging: function(a) {
        ...
        e = i.pages, i.pageList.forEach(function(a) {
            if (void 0 != a.productImageVOList && a.productImageVOList.length > 0) {
                ...
                var i = a.productImageList[0].imageURL;
                a.productImageList[0].imageURL = t.modifyPicSize(i, "_r220x220p");
            }
        }), this.setData({
            productList: this.data.productList.concat(i.pageList)
        }), this.setData({
    ...
    getProductList: function(r) {
        ...
        r.bigCateCode ? (console.log(r), console.log(2), i = !0, o = r.bigCateCode, void 0 == n.bigCateGoryCode && (n.bigCateGoryCode = o), 
    ...
    onReachBottom: function() {
        var a = this, o = n;
        console.log(o), o.current < e ? (o.current++, i ? wx.request({
            url: t.globalData.comUrl + "tabs_getZXProductListByCategory.action",
            data: o,
            success: function(t) {
                a.setData({
