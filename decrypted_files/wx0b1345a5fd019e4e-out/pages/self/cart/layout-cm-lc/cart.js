...
Page({
    ...
    splitArr: function(a) {
        ...
        o[c] = s);
        var n = (o = o.map(function(t, a, r) {
            t.isSelected = !0;
            for (var e = 0; e < t.pro.length; e++) t.pro[e].isSelected || (t.isSelected = !1);
            return t;
        })).every(function(t) {
            return t.isSelected;
        });
    ...
    selectStore: function(a) {
        for (var r = this, e = 0; e < r.data.cartData.length; e++) a.currentTarget.dataset.bid == r.data.cartData[e].branchInfoId && (a.currentTarget.dataset.sel ? r.data.cartData[e].isSelected = !1 : r.data.cartData[e].isSelected = !0);
        wx.setStorageSync("cartData" + t.globalData.autoId, r.data.cartData), r.splitArr(r.data.cartData);
    },
    selectAll: function() {
        for (var a = 0; a < this.data.cartData.length; a++) this.data.isSelectAll ? this.data.cartData[a].isSelected = !1 : this.data.cartData[a].isSelected = !0;
        wx.setStorageSync("cartData" + t.globalData.autoId, this.data.cartData), this.splitArr(this.data.cartData);
    },
    toProList: function() {
        "enterprise" == this.data.projectType || this.data.isPerson ? wx.navigateTo({
            url: t.globalData.pagesPath.proPath
        }) : wx.switchTab({
            url: t.globalData.pagesPath.proPath
        });
    },
