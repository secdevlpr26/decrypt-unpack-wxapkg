...
Page({
    ...
    onLoad: function(s) {
        var n = this;
        a = t.globalData.projectInfo, r = t.globalData.customizeTabId, n.getUserInfo(), 
        console.log(s), e = s.orderNO, o = s.id, n.setData({
            orderNO: e
        });
    },
    onShow: function() {
    ...
    isShowPay: function() {
        "1" == t.globalData.isShowPrePay && "" != this.data.cardNo && this.setData({
            isShowPrePay: !0
        });
    },
    ...
    prePay: function() {
        ...
        e.data.preMoney < e.data.orderDetail.totalMoney ? wx.showToast({
            ...
            data: {
                ...
                attach: e.data.orderNO + "_" + e.data.orderDetail.id + "%2B",
            ...
            success: function(t) {
                console.log(t.data), wx.hideToast(), "success" == t.data ? wx.showToast({
                    ...
                    success: function(t) {
                        setTimeout(function() {
                            wx.redirectTo({
                                url: "/pages/self/myOrder/myOrder?index=1"
                            });
                        }, 2e3);
                    }
                }) : wx.showModal({
