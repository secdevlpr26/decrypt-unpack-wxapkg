...
function j(t, e, i, n) {
    ...
    var f = e.width - 2 * i.padding - i.yAxisWidth - i.yAxisTitleWidth, d = Math.min(t.length, Math.ceil(f / i.fontSize / 4)), x = Math.ceil(t.length / d);
...
function Z(t, e, i, n) {
    if (e.legend) {
        T(t, e, i).legendList.forEach(function(t, a) {
            t.forEach(function(t) {});
            var o = (e.width - 0) / 2 + 5, r = e.height - i.padding - i.legendHeight + a * (i.fontSize + 8) + 5 + 8;
            n.setFontSize(i.fontSize), t.forEach(function(t) {
                switch (e.type) {
                  case "line":
                    n.beginPath(), n.setLineWidth(1), n.setStrokeStyle(t.color), n.moveTo(o - 2, r + 5), 
                    n.lineTo(o + 17, r + 5), n.stroke(), n.closePath(), n.beginPath(), n.setLineWidth(1), 
                    n.setStrokeStyle("#ffffff"), n.setFillStyle(t.color), n.moveTo(o + 7.5, r + 5), 
                    n.arc(o + 7.5, r + 5, 4, 0, 2 * Math.PI), n.fill(), n.stroke(), n.closePath();
                    break;

                  case "pie":
                  case "ring":
                    n.beginPath(), n.setFillStyle(t.color), n.moveTo(o + 7.5, r + 5), n.arc(o + 7.5, r + 5, 7, 0, 2 * Math.PI), 
                    n.closePath(), n.fill();
                    break;

                  default:
                    n.beginPath(), n.setFillStyle(t.color), n.moveTo(o, r), n.rect(o, r, 15, 10), n.closePath(), 
                    n.fill();
                }
                o += 20, n.beginPath(), n.setFillStyle(e.extra.legendTextColor || "#333333"), n.fillText(t.name, o, r + 9), 
                n.closePath(), n.stroke(), o += c(t.name) + 10;
            });
        });
    }
}
...
var tt = {
    ...
    toolTipOpacity: .7,
    toolTipLineHeight: 40,
    radarGridCount: 3,
    radarLabelTextMargin: 40
}, et = {
