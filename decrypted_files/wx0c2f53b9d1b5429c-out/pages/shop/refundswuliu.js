...
Page({
    ...
    fromsubmit: function(t) {
        ...
        var a = t.detail.value.orderid, s = t.detail.value.pkey, i = t.detail.value.tracking;
        console.log(i);
        var n = t.detail.value.logistics;
        e.sendRequest({
            url: "/index.php?c=Front/WxApp/ShopApi&a=ApplyAddition&OrderID=" + a + "&Pkey=" + s + "&Tracking=" + i + "&Logistics=" + n,
            method: "GET",
            success: function(e) {
