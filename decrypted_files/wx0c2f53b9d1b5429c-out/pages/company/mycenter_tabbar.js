...
Page({
    ...
    onLoad: function(i) {
        ...
        var s = this;
        e.registerGlobalFunctions(s), this.setData({
            optionsObj: i
    ...
    loadData: function() {
        ...
        t.isloading || (t.isloading = !0, e.sendRequest({
            ...
            success: function(a) {
                ...
                }) : (console.log("getMyCenterData fail：" + a.msg), 1 == a.needLogin ? (t.setData({
                    showUserReg: !1
                }), e.login({
                    success: function() {
                        t.setData({
    ...
    isLogin: function() {
        this.showRegTimeout = setTimeout(function() {
