...
!function(e) {
    ...
    return function t(e, n, r) {
            ...
            n.exports = function(n, r) {
                ...
                n.prototype.suppressUnhandledRejections = function() {
                    ...
                    if (this._isRejectionUnhandled()) {
                        ...
                        this._setUnhandledRejectionIsNotified(), E("unhandledRejection", x, t, this);
                    }
                    ...
                    var e = O();
                    x = "function" == typeof t ? null === e ? t : N.domainBind(e, t) : void 0;
                ...
                n.longStackTraces = function() {
                    ...
                    if (!nt.longStackTraces && F()) {
                        ...
                        }, n.prototype._captureStackTrace = h, n.prototype._attachExtraTrace = d, r.activateLongStackTraces(), 
        ...
        9: [ function(t, e, n) {
            ...
            var o, a, s = t("./es5"), c = s.freeze, l = t("./util"), u = l.inherits, p = l.notEnumerableProp, f = r("Warning", "warning"), h = r("CancellationError", "cancellation error"), d = r("TimeoutError", "timeout error"), _ = r("AggregateError", "aggregate error");
            try {
        ...
        15: [ function(t, e, n) {
            e.exports = function() {
                ...
                var b = function() {}, C = {}, w = {}, E = t("./thenables")(i, b), k = t("./promise_array")(i, b, E, p, n), j = t("./context")(i), F = (j.create, 
                t("./debuggability")(i, j)), T = (F.CapturedTrace, t("./finally")(i, E, w)), S = t("./catch_filter")(w), P = t("./nodeback"), x = h.errorObj, R = h.tryCatch;
                return i.prototype.toString = function() {
                    ...
                    var n = arguments.length > 1 && !!Object(arguments[1]).multiArgs, r = R(t)(P(e, n));
                    return r === x && e._rejectCallback(r.e, !0), e._isFateSealed() || e._setAsyncGuaranteed(), 
                    e;
                }, i.all = function(t) {
                    ...
                    if (0 != (50397184 & u)) {
                        ...
                        0 != (33554432 & u) ? (d = l._rejectionHandler0, f = t) : 0 != (16777216 & u) ? (d = l._fulfillmentHandler0, 
                        f = e, l._unsetRejectionIsUnhandled()) : (_ = l._settlePromiseLateCancellationObserver, 
                        d = new m("late cancellation observer"), l._attachExtraTrace(d), f = e), v.invoke(_, l, {
                    ...
                    if (0 == (65536 & i)) {
                        r._pushContext();
                        var o;
                        e === C ? n && "number" == typeof n.length ? o = R(t).apply(this._boundValue(), n) : (o = x, 
                        o.e = new g("cannot .spread() a non-array: " + h.classString(n))) : o = R(t).call(e, n);
                        var a = r._popContext();
                        0 == (65536 & (i = r._bitField)) && (o === w ? r._reject(n) : o === x ? r._rejectCallback(o.e, !1) : (F.checkForgottenReturns(o, a, "", r, this), 
                    ...
                    R(e).call(r, o) === x && t._reject(x.e)) : e === u ? t._fulfill(u.call(r)) : r instanceof n ? r._promiseCancelled(t) : a || t instanceof k ? t._cancel() : r.cancel()) : "function" == typeof e ? a ? (c && t._setAsyncGuaranteed(), 
                ...
                }, h.notEnumerableProp(i, "_makeSelfResolutionError", l), t("./method")(i, b, E, p, F), 
                t("./bind")(i, b, E, F), t("./cancel")(i, k, p, F), t("./direct_resolve")(i), t("./synchronous_inspection")(i), 
                t("./join")(i, k, E, b, v, c), i.Promise = i, i.version = "3.5.0", h.toFastProperties(i), 
                h.toFastProperties(i.prototype), s({
                    ...
                    c: 3
                }), s(1), s(function() {}), s(void 0), s(!1), s(new i(b)), F.setBounds(_.firstLineError, h.lastLineError), 
                i;
            };
        }, {
            "./async": 1,
        ...
        21: [ function(e, n, r) {
            ...
            var p, f = e("./es5"), h = "undefined" == typeof navigator, d = {
                e: {}
            }, _ = "undefined" != typeof self ? self : "undefined" != typeof window ? window : "undefined" != typeof global ? global : void 0 !== this ? this : null, v = function() {
            ...
            var w = "undefined" != typeof process && "[object process]" === u(process).toLowerCase(), E = "undefined" != typeof process && void 0 !== process.env, k = {
                isClass: function(t) {
                    try {
