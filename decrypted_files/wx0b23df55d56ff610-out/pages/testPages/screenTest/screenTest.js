Page({
    data: {
        ...
        curBack: "#000",
        fontColor: "#999",
        curContent: "请着重检测屏幕漏光、星光屏、内屏损伤等问题",
        curTitle: "点击屏幕切换背景颜色",
        curIndex: 0,
        arr: [ {
            content: "请着重检测屏幕漏光、星光屏、内屏损伤等问题",
            tip: "点击屏幕切换背景颜色",
            bgColor: "#000"
        }, {
            content: "请着重检测亮点、坏点、漏光等问题",
            tip: "点击屏幕切换背景颜色",
            bgColor: "#fff"
        }, {
            content: "请仔细检测屏幕色差",
    ...
    screenClick: function() {
        ...
        if (this.data.curIndex >= 3) {
            ...
            var U = this.data.curIndex + 1, B = this.data.fontColor, l = this.data.arr, Z = l[U].content, V = l[U].tip, G = l[U].bgColor;
            l[U].color && (B = l[U].color), this.setData({
                curIndex: U,
                fontColor: B,
                curContent: Z,
                curTitle: V,
    ...
    goToWifiTest: function(A) {
        var Q = this.data.dataArr, U = JSON.stringify(A);
        Q.push(U);
        var B = Q.join("，");
        wx.redirectTo({
