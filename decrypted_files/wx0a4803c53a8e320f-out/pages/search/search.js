...
var a, e = getApp(), i = e.globalData.projectInfo, n = e.globalData.customizeTabId, o = 1, s = 0, r = "", c = !0;
...
Page(t({
    ...
    onLoad: function(t) {
        r = "", i = e.globalData.projectInfo, n = e.globalData.customizeTabId, this.setData({
            search_type: t.type
        }), this.getProductInfo();
    },
    ...
    confirm: function() {
        o = 1, this.moneyWay(), this.setData({
            pageList: [],
            hiddenTo: !0
        }), this.getProductInfo();
    },
    ...
    getNewsInfo: function() {
        ...
        c && (c = !1, wx.request({
            ...
            data: {
                appId: i.appId,
                customizeTabId: n.LynxPhoto_H_Info_Tab_Level2,
                current: o,
                searchKey: r
            },
            success: function(a) {
    ...
    getProductInfo: function() {
        var t = this, a = {
            appId: i.appId,
            customizeTabId: n.LynxProductList,
            current: o,
            status: 2,
            productName: r,
    ...
    search: function() {
        this.setData({
            ...
            hidden: !0,
            noSearch: !0
        }), o = 1, "0" == this.data.search_type ? this.getProductInfo() : "1" == this.data.search_type ? this.getStoreInfo() : this.getNewsInfo();
    },
    ...
    scrolltolower: function() {
        o < s && (o++, 0 == this.data.search_type ? this.getProductInfo() : 1 == this.data.search_type ? this.getStoreInfo() : this.getNewsInfo());
    }
}, "scrolltolower", function() {
    o < s ? (o++, 0 == this.data.search_type ? this.getProductInfo() : 1 == this.data.search_type ? this.getStoreInfo() : this.getNewsInfo()) : o > 1 && (this.data.pageList.length > 1 ? this.setData({
        bottomHint: !1
    }) : this.setData({
        bottomHint: !0
    }));
