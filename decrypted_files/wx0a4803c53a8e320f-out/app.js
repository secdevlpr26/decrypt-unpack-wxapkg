...
App({
    ...
    getCustomizeId: function(a) {
        ...
        for (var o = 0; o < t.dataInfo.customizeTabsList.length; o++) {
            ...
            if (n.data && n.data.customizeTabsList && n.data.customizeTabsList.length > 0) for (var s = 0; s < n.data.customizeTabsList.length; s++) {
                var i = n.data.customizeTabsList[s];
                if (i.sysTabNameTag && "" != i.sysTabNameTag && i.sysTabNameTag == a) return i.customizeId || i.id;
                if (i.sysTabName && "" != i.sysTabName && i.sysTabName == a) return i.customizeId || i.id;
            }
        }
    },
    ...
    filterSpecialSymbol: function(t) {
        ...
        t = t.replace(/&middot;/g, "·"), t = t.replace(/&hellip;/g, "…"), t = t.replace(/<img(?=.*?\/>)/gi, '<img style="width: 100%; height: auto;" ');
    }
});