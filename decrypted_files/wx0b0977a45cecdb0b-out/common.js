var t = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(t) {
    ...
    loadPageModules: function(t) {
        ...
        n && n.length > 1 && (o = n[1]);
        var i = decodeURIComponent(t.scene || ""), r = i.match(/sharepage=(CustomPage_\d+)/i);
        r && r.length > 1 && (o = r[1]), console.log("page:" + o, "scene:" + i), this.sendRequest({
    ...
    setFloatLayerInfo: function(t, e) {
        ...
        if (!t) {
            var a = getApp();
            if (a.globalData && a.globalData.baseInfo && (t = (e = a.globalData.baseInfo).FloatLayerSetting), 
            !t) return void u.sendRequest({
                url: "/index.php?c=Front/WxApp/JsonApi&a=getBaseInfo",
                method: "POST",
                hideLoading: !0,
                success: function(t) {
                    t.success && u.setFloatLayerInfo(t.info.FloatLayerSetting || {}, t.info);
                }
            });
        }
        var o = {};
        ...
        /productdetail/i.test(i) && /(meirong)|(peixun)|(shop)|(yunzhi)/i.test(e.Industry) && (r = !0);
        var s = 0;
    ...
    adjustFloatLayer: function(t) {
        ...
        l && l.length > 1 && (s = !0);
        var u = s && /(productdetail)|(servicedetail)|(custompage)/i.test(n) && /(meirong)|(peixun)|(meifa)|(jianshen)|(jianzhan)/i.test(e.globalData.baseInfo.Industry);
        return u = u || s && /custompage/i.test(n), t.EnableGoToHomeIndex = u ? 1 : 0, t;
    },
