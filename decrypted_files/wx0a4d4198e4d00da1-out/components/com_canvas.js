                ...
                var t = _asyncToGenerator(regeneratorRuntime.mark(function e(t) {
                    ...
                    return regeneratorRuntime.wrap(function(e) {
                        for (;;) switch (e.prev = e.next) {
                          case 0:
                            n = t.currentTarget.dataset.vm, r = (0, _lodashGet2.default)(n, "record"), wx.canvasToTempFilePath({
                                x: 0,
                                y: 0,
                                width: .82 * wx.getSystemInfoSync().windowWidth,
                                height: .75 * wx.getSystemInfoSync().windowHeight,
                                                ...
                                                return regeneratorRuntime.wrap(function(e) {
                                                    for (;;) switch (e.prev = e.next) {
                                                      ...
                                                      case 2:
                                                        ...
                                                        return e.next = 5, _core.core.updateRecordId(r);
