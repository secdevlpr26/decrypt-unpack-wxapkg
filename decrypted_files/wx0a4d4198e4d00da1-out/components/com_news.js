...
var _wepy = require("./../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _core = require("./../lib/core.js"), com_news = function(e) {
    function t() {
        var e, o, r, n;
        ...
        r.components = {}, r.methods = {
            ...
            goMore: function(e, t) {
                _core.tools.goNewPage("/pages/news/newsLst?id=" + e + "&type=" + t);
            }
