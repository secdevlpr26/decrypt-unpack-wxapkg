...
var _wepy = require("./../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _core = require("./../lib/core.js"), com_live = function(e) {
    function t() {
        var e, o, r, n;
        ...
        r.components = {}, r.methods = {
            goLive: function(e, t) {
                _core.tools.goNewPage("/pages/live/live?pageIndex=" + e + "&comIndex=" + t);
            }
