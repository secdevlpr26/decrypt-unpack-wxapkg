...
var _wepy = require("./../npm/wepy/lib/wepy.js"), _wepy2 = _interopRequireDefault(_wepy), _core = require("./../lib/core.js"), com_goodItem = function(e) {
    function t() {
        var e, o, r, n;
        ...
        r.config = {
            ...
            pathGood: function(e) {
                "number" == typeof e && _core.tools.pathGood(e, "buy", !0);
            }
