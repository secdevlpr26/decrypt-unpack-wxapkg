...
}, showdown = {}, parsers = {}, extensions = {}, globalOptions = getDefaultOpts(!0), flavor = {
    github: {
...
var rgxFindMatchPos = function(e, r, n, t) {
    var o, s, a, i, l, c = t || "", h = c.indexOf("g") > -1, u = new RegExp(r + "|" + n, "g" + c.replace(/g/g, "")), d = new RegExp(r, c.replace(/g/g, "")), p = [];
    do {
        for (o = 0; a = u.exec(e); ) if (d.test(a[0])) o++ || (s = u.lastIndex, i = s - a[0].length); else if (o && !--o) {
...
showdown.helper.matchRecursiveRegExp = function(e, r, n, t) {
    ...
    function r(e, r) {
        if (r = r || null, showdown.helper.isString(e)) {
            if (e = showdown.helper.stdExtName(e), r = e, showdown.extensions[e]) return console.warn("DEPRECATION WARNING: " + e + " is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!"), 
            void n(showdown.extensions[e], e);
    ...
    function o(e) {
        var r = e.match(/^\s*/)[0].length, n = new RegExp("^\\s{0," + r + "}", "gm");
        return e.replace(n, "");
    }
    var s = {}, a = [], i = [], l = {};
    !function() {
        ...
        e = e.replace(/\r/g, "\n"), s.smartIndentationFix && (e = o(e)), e = e, e = showdown.subParser("detab")(e, s, r), 
        e = showdown.subParser("stripBlankLines")(e, s, r), showdown.helper.forEach(a, function(n) {
            e = showdown.subParser("runExtension")(n, e, s, r);
        }), e = showdown.subParser("hashPreCodeTags")(e, s, r), e = showdown.subParser("githubCodeBlocks")(e, s, r), 
        e = showdown.subParser("hashHTMLBlocks")(e, s, r), e = showdown.subParser("hashHTMLSpans")(e, s, r), 
        e = showdown.subParser("stripLinkDefinitions")(e, s, r), e = showdown.subParser("blockGamut")(e, s, r), 
        e = showdown.subParser("unhashHTMLSpans")(e, s, r), e = showdown.subParser("unescapeSpecialChars")(e, s, r), 
        e = e.replace(/~D/g, "$$"), e = e.replace(/~T/g, "~"), showdown.helper.forEach(i, function(n) {
            e = showdown.subParser("runExtension")(n, e, s, r);
        }), e;
    ...
    e = n.converter._dispatch("anchors.before", e, r, n);
    var t = function(e, r, t, o, s, a, i, l) {
        showdown.helper.isUndefined(l) && (l = ""), e = r;
        var c = t, h = o.toLowerCase(), u = s, d = l;
        ...
        u = showdown.helper.escapeCharacters(u, "*_", !1);
        var p = '<a href="' + u + '"';
        return "" !== d && null !== d && (d = d.replace(/"/g, "&quot;"), d = showdown.helper.escapeCharacters(d, "*_", !1), 
        p += ' title="' + d + '"'), p += ">" + c + "</a>";
    };
    return e = e.replace(/(\[((?:\[[^\]]*]|[^\[\]])*)][ ]?(?:\n[ ]*)?\[(.*?)])()()()()/g, t), 
    e = e.replace(/(\[((?:\[[^\]]*]|[^\[\]])*)]\([ \t]*()<?(.*?(?:\(.*?\).*?)?)>?[ \t]*((['"])(.*?)\6[ \t]*)?\))/g, t), 
    e = e.replace(/(\[([^\[\]]+)])()()()()()/g, t), e = n.converter._dispatch("anchors.after", e, r, n);
    ...
    e = n.converter._dispatch("autoLinks.before", e, r, n);
    var s = /\b(((https?|ftp|dict):\/\/|www\.)[^'">\s]+\.[^'">\s]+)(?=\s|$)(?!["<>])/gi, a = /<(((https?|ftp|dict):\/\/|www\.)[^'">\s]+)>/gi, i = /(?:^|[ \n\t])([A-Za-z0-9!#$%&'*+-\/=?^_`\{|}~\.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?:$|[ \n\t])/gi, l = /<(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
    return e = e.replace(a, t), e = e.replace(l, o), r.simplifiedAutoLink && (e = e.replace(s, t), 
    e = e.replace(i, o)), e = n.converter._dispatch("autoLinks.after", e, r, n);
    ...
    e = e.replace(/^[ ]{0,2}([ ]?_[ ]?){3,}[ \t]*$/gm, t), e = showdown.subParser("lists")(e, r, n), 
    e = showdown.subParser("codeBlocks")(e, r, n), e = showdown.subParser("tables")(e, r, n), 
    e = showdown.subParser("hashHTMLBlocks")(e, r, n), e = showdown.subParser("paragraphs")(e, r, n), 
    ...
    return e = n.converter._dispatch("blockQuotes.before", e, r, n), e = e.replace(/((^[ \t]{0,3}>[ \t]?.+\n(.+\n)*\n*)+)/gm, function(e, t) {
        var o = t;
        return o = o.replace(/^[ \t]*>[ \t]?/gm, "~0"), o = o.replace(/~0/g, ""), o = o.replace(/^[ \t]+$/gm, ""), 
        o = showdown.subParser("githubCodeBlocks")(o, r, n), o = showdown.subParser("blockGamut")(o, r, n), 
    ...
    e = n.converter._dispatch("codeBlocks.before", e, r, n), e += "~0";
    var t = /(?:\n\n|^)((?:(?:[ ]{4}|\t).*\n+)+)(\n*[ ]{0,3}[^ \t\n]|(?=~0))/g;
    return e = e.replace(t, function(e, t, o) {
        var s = t, a = o, i = "\n";
        return s = showdown.subParser("outdent")(s), s = showdown.subParser("encodeCode")(s), 
        s = showdown.subParser("detab")(s), s = s.replace(/^\n+/g, ""), s = s.replace(/\n+$/g, ""), 
        r.omitExtraWLInCodeBlocks && (i = ""), s = "<pre><code>" + s + i + "</code></pre>", 
        showdown.subParser("hashBlock")(s, r, n) + a;
    }), e = e.replace(/~0/, ""), e = n.converter._dispatch("codeBlocks.after", e, r, n);
}), showdown.subParser("codeSpans", function(e, r, n) {
    return e = n.converter._dispatch("codeSpans.before", e, r, n), void 0 === e && (e = ""), 
    e = e.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function(e, r, n, t) {
        var o = t;
        return o = o.replace(/^([ \t]*)/g, ""), o = o.replace(/[ \t]*$/g, ""), o = showdown.subParser("encodeCode")(o), 
        r + "<code>" + o + "</code>";
    ...
    e += "~0", e = e.replace(/(?:^|\n)```(.*)\n([\s\S]*?)\n```/g, function(e, t, o) {
        ...
        return o = showdown.subParser("encodeCode")(o), o = showdown.subParser("detab")(o), 
        o = o.replace(/^\n+/g, ""), o = o.replace(/\n+$/g, ""), o = "<pre><code" + (t ? ' class="' + t + " language-" + t + '"' : "") + ">" + o + s + "</code></pre>", 
        o = showdown.subParser("hashBlock")(o, r, n), "\n\n~G" + (n.ghCodeBlocks.push({
            text: e,
            codeblock: o
        }) - 1) + "G\n\n";
    ...
    for (var t = [ "pre", "div", "h1", "h2", "h3", "h4", "h5", "h6", "blockquote", "table", "dl", "ol", "ul", "script", "noscript", "form", "fieldset", "iframe", "math", "style", "section", "header", "footer", "nav", "article", "aside", "address", "audio", "canvas", "figure", "hgroup", "output", "video", "p" ], o = function(e, r, t, o) {
        var s = e;
        return -1 !== t.search(/\bmarkdown\b/) && (s = t + n.converter.makeHtml(r) + o), 
        "\n\n~K" + (n.gHtmlBlocks.push(s) - 1) + "K\n\n";
    }, s = 0; s < t.length; ++s) e = showdown.helper.replaceRecursiveRegExp(e, o, "^(?: |\\t){0,3}<" + t[s] + "\\b[^>]*>", "</" + t[s] + ">", "gim");
    return e = e.replace(/(\n[ ]{0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g, showdown.subParser("hashElement")(e, r, n)), 
    e = e.replace(/(<!--[\s\S]*?-->)/g, showdown.subParser("hashElement")(e, r, n)), 
    e = e.replace(/(?:\n\n)([ ]{0,3}(?:<([?%])[^\r]*?\2>)[ \t]*(?=\n{2,}))/g, showdown.subParser("hashElement")(e, r, n));
    ...
    return e = showdown.helper.replaceRecursiveRegExp(e, t, "^(?: |\\t){0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>", "^(?: |\\t){0,3}</code>\\s*</pre>", "gim");
}), showdown.subParser("headers", function(e, r, n) {
    function t(e) {
        var r, t = e.replace(/[^\w]/g, "").toLowerCase();
        return n.hashLinkCounts[t] ? r = t + "-" + n.hashLinkCounts[t]++ : (r = t, n.hashLinkCounts[t] = 1), 
        !0 === o && (o = "section"), showdown.helper.isString(o) ? o + r : r;
    }
    e = n.converter._dispatch("headers.before", e, r, n);
    var o = r.prefixHeaderId, s = isNaN(parseInt(r.headerLevelStart)) ? 1 : parseInt(r.headerLevelStart), a = r.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm, i = r.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
    return e = e.replace(a, function(e, o) {
        var a = showdown.subParser("spanGamut")(o, r, n), i = r.noHeaderId ? "" : ' id="' + t(o) + '"', l = s, c = "<h" + l + i + ">" + a + "</h" + l + ">";
        return showdown.subParser("hashBlock")(c, r, n);
    }), e = e.replace(i, function(e, o) {
        var a = showdown.subParser("spanGamut")(o, r, n), i = r.noHeaderId ? "" : ' id="' + t(o) + '"', l = s + 1, c = "<h" + l + i + ">" + a + "</h" + l + ">";
        return showdown.subParser("hashBlock")(c, r, n);
    }), e = e.replace(/^(#{1,6})[ \t]*(.+?)[ \t]*#*\n+/gm, function(e, o, a) {
        var i = showdown.subParser("spanGamut")(a, r, n), l = r.noHeaderId ? "" : ' id="' + t(a) + '"', c = s - 1 + o.length, h = "<h" + c + l + ">" + i + "</h" + c + ">";
    ...
    function t(e, r, t, o, s, a, i, l) {
        var c = n.gUrls, h = n.gTitles, u = n.gDimensions;
        if (t = t.toLowerCase(), l || (l = ""), "" === o || null === o) {
            if ("" !== t && null !== t || (t = r.toLowerCase().replace(/ ?\n/g, " ")), o = "#" + t, 
            showdown.helper.isUndefined(c[t])) return e;
            o = c[t], showdown.helper.isUndefined(h[t]) || (l = h[t]), showdown.helper.isUndefined(u[t]) || (s = u[t].width, 
            a = u[t].height);
        }
        r = r.replace(/"/g, "&quot;"), r = showdown.helper.escapeCharacters(r, "*_", !1), 
        o = showdown.helper.escapeCharacters(o, "*_", !1);
        var d = '<img src="' + o + '" alt="' + r + '"';
        return l && (l = l.replace(/"/g, "&quot;"), l = showdown.helper.escapeCharacters(l, "*_", !1), 
        d += ' title="' + l + '"'), s && a && (s = "*" === s ? "auto" : s, a = "*" === a ? "auto" : a, 
        d += ' width="' + s + '"', d += ' height="' + a + '"'), d += " />";
    }
    e = n.converter._dispatch("images.before", e, r, n);
    var o = /!\[(.*?)]\s?\([ \t]*()<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(['"])(.*?)\6[ \t]*)?\)/g, s = /!\[([^\]]*?)] ?(?:\n *)?\[(.*?)]()()()()()/g;
    return e = e.replace(s, t), e = e.replace(o, t), e = n.converter._dispatch("images.after", e, r, n);
}), showdown.subParser("italicsAndBold", function(e, r, n) {
    return e = n.converter._dispatch("italicsAndBold.before", e, r, n), r.literalMidWordUnderscores ? (e = e.replace(/(^|\s|>|\b)__(?=\S)([\s\S]+?)__(?=\b|<|\s|$)/gm, "$1<strong>$2</strong>"), 
    ...
    e = e.replace(/(\*|_)(?=\S)([^\r]*?\S)\1/g, "<em>$2</em>")), e = n.converter._dispatch("italicsAndBold.after", e, r, n);
}), showdown.subParser("lists", function(e, r, n) {
    function t(e, t) {
        n.gListLevel++, e = e.replace(/\n{2,}$/, "\n"), e += "~0";
        var o = /(\n)?(^[ \t]*)([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(~0|\2([*+-]|\d+[.])[ \t]+))/gm, s = /\n[ \t]*\n(?!~0)/.test(e);
        return e = e.replace(o, function(e, t, o, a, i, l, c) {
            c = c && "" !== c.trim();
            var h = showdown.subParser("outdent")(i, r, n), u = "";
            return l && r.tasklists && (u = ' class="task-list-item" style="list-style-type: none;"', 
            ...
            })), t || h.search(/\n{2,}/) > -1 ? (h = showdown.subParser("githubCodeBlocks")(h, r, n), 
            h = showdown.subParser("blockGamut")(h, r, n)) : (h = showdown.subParser("lists")(h, r, n), 
            h = h.replace(/\n$/, ""), h = s ? showdown.subParser("paragraphs")(h, r, n) : showdown.subParser("spanGamut")(h, r, n)), 
            h = "\n<li" + u + ">" + h + "</li>\n";
        }), e = e.replace(/~0/g, ""), n.gListLevel--, t && (e = e.replace(/\s+$/, "")), 
        e;
    }
    function o(e, r, n) {
        var o = "ul" === r ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm, s = [], a = "";
        if (-1 !== e.search(o)) {
            !function e(s) {
                var i = s.search(o);
                -1 !== i ? (a += "\n\n<" + r + ">" + t(s.slice(0, i), !!n) + "</" + r + ">\n\n", 
                r = "ul" === r ? "ol" : "ul", o = "ul" === r ? /^ {0,2}\d+\.[ \t]/gm : /^ {0,2}[*+-][ \t]/gm, 
                e(s.slice(i))) : a += "\n\n<" + r + ">" + t(s, !!n) + "</" + r + ">\n\n";
            }(e);
    ...
    e = e.replace(s, function(e, r, n, t) {
    ...
    e = n.converter._dispatch("paragraphs.before", e, r, n), e = e.replace(/^\n+/g, ""), 
    e = e.replace(/\n+$/g, "");
    for (var t = e.split(/\n{2,}/g), o = [], s = t.length, a = 0; a < s; a++) {
        var i = t[a];
        i.search(/~(K|G)(\d+)\1/g) >= 0 ? o.push(i) : (i = showdown.subParser("spanGamut")(i, r, n), 
        i = i.replace(/^([ \t]*)/g, "<p>"), i += "</p>", o.push(i));
    }
    for (s = o.length, a = 0; a < s; a++) {
        for (var l = "", c = o[a], h = !1; c.search(/~(K|G)(\d+)\1/) >= 0; ) {
            var u = RegExp.$1, d = RegExp.$2;
            l = "K" === u ? n.gHtmlBlocks[d] : h ? showdown.subParser("encodeCode")(n.ghCodeBlocks[d].text) : n.ghCodeBlocks[d].codeblock, 
            l = l.replace(/\$/g, "$$$$"), c = c.replace(/(\n\n)?~(K|G)\d+\2(\n\n)?/, l), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(c) && (h = !0);
        }
        o[a] = c;
    }
    return e = o.join("\n\n"), e = e.replace(/^\n+/g, ""), e = e.replace(/\n+$/g, ""), 
    ...
    e = showdown.subParser("italicsAndBold")(e, r, n), e = showdown.subParser("strikethrough")(e, r, n), 
    e = e.replace(/  +\n/g, " <br />\n"), e = n.converter._dispatch("spanGamut.after", e, r, n);
}), showdown.subParser("strikethrough", function(e, r, n) {
    return r.strikethrough && (e = n.converter._dispatch("strikethrough.before", e, r, n), 
    e = e.replace(/(?:~T){2}([\s\S]+?)(?:~T){2}/g, "<del>$1</del>"), e = n.converter._dispatch("strikethrough.after", e, r, n)), 
    e;
}), showdown.subParser("stripBlankLines", function(e) {
    return e.replace(/^[ \t]+$/gm, "");
}), showdown.subParser("stripLinkDefinitions", function(e, r, n) {
    var t = /^ {0,3}\[(.+)]:[ \t]*\n?[ \t]*<?(\S+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*\n?[ \t]*(?:(\n*)["|'(](.+?)["|')][ \t]*)?(?:\n+|(?=~0))/gm;
    return e += "~0", e = e.replace(t, function(e, t, o, s, a, i, l) {
        return t = t.toLowerCase(), n.gUrls[t] = showdown.subParser("encodeAmpsAndAngles")(o), 
        i ? i + l : (l && (n.gTitles[t] = l.replace(/"|'/g, "&quot;")), r.parseImgDimensions && s && a && (n.gDimensions[t] = {
            width: s,
            height: a
        }), "");
    }), e = e.replace(/~0/, "");
    ...
    function o(e, t) {
        var o = "";
        return e = e.trim(), r.tableHeaderId && (o = ' id="' + e.replace(/ /g, "_").toLowerCase() + '"'), 
        e = showdown.subParser("spanGamut")(e, r, n), "<th" + o + t + ">" + e + "</th>\n";
    }
    function s(e, t) {
    ...
    var i = /^[ \t]{0,3}\|?.+\|.+\n[ \t]{0,3}\|?[ \t]*:?[ \t]*(?:-|=){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:-|=){2,}[\s\S]+?(?:\n\n|~0)/gm;
    return e = n.converter._dispatch("tables.before", e, r, n), e = e.replace(i, function(e) {
        var r, n = e.split("\n");
        ...
        for (r = 0; r < i.length; ++r) showdown.helper.isUndefined(u[r]) && (u[r] = ""), 
        h.push(o(i[r], u[r]));
        for (r = 0; r < c.length; ++r) {
            for (var p = [], w = 0; w < h.length; ++w) showdown.helper.isUndefined(c[r][w]), 
            p.push(s(c[r][w], u[w]));
            d.push(p);
        }
        return a(h, d);
